    ...
    return (
        <div className=''>
            ...
            <div class="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                ...
                <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? <Link to='/signup' class="font-medium text-blue-700 dark:text-gray-200 hover:underline">Create One</Link></p>
            </div>
        </div>
    );
};
