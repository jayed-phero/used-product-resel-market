...
const Footer = () => {
    return (
        <div>
            <footer class="bg-black text-white dark:bg-gray-900 md:px-20 px-5">
                <div class="container p-6 mx-auto">
                    ...
                    <hr class="h-px my-6 bg-gray-200 border-none dark:bg-gray-700"/>
                        ...
                        <div>
                            <p class="text-center text-gray-500 dark:text-gray-400">© mobile<span className='text-regal-yellow'>ZONE</span> 2022 - All rights reserved</p>
                        </div>
                </div>
            </footer>
        </div>
